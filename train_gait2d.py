...
actor.add(Dense(units=32, kernel_initializer=initializers.RandomNormal(stddev=0.01),
...
# Ctrl + C.
if args.train:
    agent.fit(env, nb_steps=nallsteps, visualize=args.visualize, verbose=1, nb_max_episode_steps=1000, log_interval=1000)
